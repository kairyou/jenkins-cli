...
preset-action-input = Enter {$keys}
preset-action-invalid = Invalid input. Enter {$keys}
preset-action-build = y  Build now
preset-action-edit = e  Edit and build
preset-action-edit-update-current = u  Edit, update preset, then build
preset-action-edit-save-as = s  Edit, save new preset, then build
preset-action-update-current = u  Update preset and build
preset-action-save-as = s  Save as new preset and build
preset-action-build-once = y  Build now
